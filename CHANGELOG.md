...
- Bump go toolchain to 1.27.0 and update ginkgo/gomega/pprof deps
- Add do-not-merge label gate workflow for PRs
- Opt into autoMerge.trivial for mechanically-trivial update PRs
